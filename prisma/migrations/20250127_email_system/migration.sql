...
CREATE TABLE IF NOT EXISTS "EmailQueue" (
  ...
  "emailLogId" UUID REFERENCES "EmailLog"("id") ON DELETE SET NULL,
  "createdAt" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP
);
...
INSERT INTO "SystemEmailTemplate" ("key", "name", "description", "subject", "htmlContent", "textContent", "variables", "category") VALUES
-- User Management
