...
-- First check if Theo Von has episodes with YouTube IDs
...
-- Insert YouTube Analytics data for recent episodes  
...
SELECT
  ...
  FLOOR(RANDOM() * 450000 + 50000)::bigint as views,
  ...
  FLOOR((RANDOM() * 450000 + 50000) * (8 + RANDOM() * 4) / 60)::bigint as "watchTimeMinutes",
  ...
  (35 + RANDOM() * 30)::numeric(5,2) as "averageViewPercentage",
