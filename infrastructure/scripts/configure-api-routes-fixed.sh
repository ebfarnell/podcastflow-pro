...
create_api_resource "$ROOT_ID" "team" "PodcastFlowPro-Team" "GET POST PUT DELETE"
...
create_api_resource "$ROOT_ID" "security" "PodcastFlowPro-Security" "GET"
...
create_api_resource "$ROOT_ID" "billing" "PodcastFlowPro-Billing" "GET"
...
create_api_resource "$ROOT_ID" "api-webhooks" "PodcastFlowPro-APIWebhooks" "GET"
...
create_api_resource "$ROOT_ID" "backups" "PodcastFlowPro-Backup" "GET POST"
...
echo "1. Test the endpoints using the test script"
